...
class RegistrationSectionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'icon_plus_card.title.en' => ['nullable', 'string'],
            'icon_plus_card.title.ar' => ['nullable', 'string'],
            'icon_plus_card.description.en' => ['nullable', 'string'],
            'icon_plus_card.description.ar' => ['nullable', 'string'],
            'icon_plus_card.cta_label.en' => ['nullable', 'string'],
            'icon_plus_card.cta_label.ar' => ['nullable', 'string'],
            'icon_plus_form.title.en' => ['nullable', 'string'],
            'icon_plus_form.title.ar' => ['nullable', 'string'],
            'icon_plus_form.step_one.en' => ['nullable', 'string'],
            'icon_plus_form.step_one.ar' => ['nullable', 'string'],
            'icon_plus_form.step_two.en' => ['nullable', 'string'],
            'icon_plus_form.step_two.ar' => ['nullable', 'string'],
            'icon_plus_form.cta_next.en' => ['nullable', 'string'],
            'icon_plus_form.cta_next.ar' => ['nullable', 'string'],
            'icon_plus_form.cta_back.en' => ['nullable', 'string'],
            'icon_plus_form.cta_back.ar' => ['nullable', 'string'],
            'icon_plus_form.cta_submit.en' => ['nullable', 'string'],
            'icon_plus_form.cta_submit.ar' => ['nullable', 'string'],
            'icon_plus_form.fields_step_one' => ['nullable', 'array', 'min:1'],
            'icon_plus_form.fields_step_one.*.name' => ['nullable', 'string'],
            'icon_plus_form.fields_step_one.*.label.en' => ['nullable', 'string'],
            'icon_plus_form.fields_step_one.*.label.ar' => ['nullable', 'string'],
            'icon_plus_form.fields_step_one.*.placeholder.en' => ['nullable', 'string'],
            'icon_plus_form.fields_step_one.*.placeholder.ar' => ['nullable', 'string'],
            'icon_plus_form.fields_step_one.*.hint.en' => ['nullable', 'string'],
            'icon_plus_form.fields_step_one.*.hint.ar' => ['nullable', 'string'],
            'icon_plus_form.fields_step_two' => ['nullable', 'array', 'min:1'],
            'icon_plus_form.fields_step_two.*.name' => ['nullable', 'string'],
            'icon_plus_form.fields_step_two.*.label.en' => ['nullable', 'string'],
            'icon_plus_form.fields_step_two.*.label.ar' => ['nullable', 'string'],
            'icon_plus_form.fields_step_two.*.placeholder.en' => ['nullable', 'string'],
            'icon_plus_form.fields_step_two.*.placeholder.ar' => ['nullable', 'string'],
            'icon_plus_form.fields_step_two.*.hint.en' => ['nullable', 'string'],
            'icon_plus_form.fields_step_two.*.hint.ar' => ['nullable', 'string'],

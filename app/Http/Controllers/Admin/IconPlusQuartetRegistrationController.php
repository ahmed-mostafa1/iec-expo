...
class IconPlusQuartetRegistrationController extends Controller
{
    ...
    {
        return view('admin.icon-plus-quartet-registrations.index');
    }

    public function show(IconPlusQuartetRegistration $registration): View
    {
        return view('admin.icon-plus-quartet-registrations.show', compact('registration'));
    }

    public function updateStatus(Request $request, IconPlusQuartetRegistration $registration): RedirectResponse
    {
    ...
    public function downloadPdf(IconPlusQuartetRegistration $registration): BinaryFileResponse
    {
    ...
    public function regeneratePdf(IconPlusQuartetRegistration $registration): RedirectResponse
    {
        try {
            $pdfPath = $this->pdfService->generateIconPlusQuartetPdf($registration);
    ...
    {
        $query = IconPlusQuartetRegistration::query();
        ...
        $fileName = 'icon_plus_quartet_registrations_'.now()->format('Ymd_His').'.csv';

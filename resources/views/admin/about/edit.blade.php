...
@section('content')
    ...
    <form method="POST"
          ...
          class="max-w-3xl space-y-5 bg-white border border-gray-200 rounded-xl p-4 text-xs">
        @csrf
        @method('PUT')
        ...
        <div class="grid md:grid-cols-2 gap-4">
            <div>
                ...
                <textarea name="mission_en" rows="5"
                          class="w-full rounded-lg border-gray-300 text-xs">{{ old('mission_en', $about->mission_en) }}</textarea>
            ...
            <div>
                ...
                <textarea name="mission_ar" rows="5"
                          class="w-full rounded-lg border-gray-300 text-xs">{{ old('mission_ar', $about->mission_ar) }}</textarea>
        ...
        <div class="grid md:grid-cols-2 gap-4">
            <div>
                ...
                <textarea name="goals_en" rows="5"
                          class="w-full rounded-lg border-gray-300 text-xs">{{ old('goals_en', $about->goals_en) }}</textarea>
            ...
            <div>
                ...
                <textarea name="goals_ar" rows="5"
                          class="w-full rounded-lg border-gray-300 text-xs">{{ old('goals_ar', $about->goals_ar) }}</textarea>
        ...
        <div class="pt-2">
            <button type="submit"
                    class="inline-flex items-center rounded-lg bg-gray-900 px-4 py-1.5 text-xs font-semibold text-white hover:bg-black">
                {{ __('Save changes') }}
            </button>
        </div>
    </form>

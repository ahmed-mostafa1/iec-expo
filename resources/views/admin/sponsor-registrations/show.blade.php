...
@section('content')
    <h1 class="text-lg font-semibold mb-4">
        {{ __('Sponsor registration') }} #{{ $registration->id }}
    </h1>
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        @if($registration->pdf_path)
                            <a href="{{ route('admin.sponsors.download-pdf', $registration) }}"
                               class="text-[11px] text-emerald-700 hover:text-emerald-900">
                                {{ __('Download PDF') }}
                            </a>
                        @else
                    ...
                    <form method="POST" action="{{ route('admin.sponsors.regenerate-pdf', $registration) }}">
                        @csrf
                        <button
                            type="submit"

    ...
    <form method="POST"
        ...
        <div>
            ...
            <textarea name="description_en" rows="3"
                      class="w-full rounded-lg border-gray-300 text-s">{{ old('description_en', $organizer->description_en) }}</textarea>
        ...
        <div>
            ...
            <textarea name="description_ar" rows="3"
                      class="w-full rounded-lg border-gray-300 text-s">{{ old('description_ar', $organizer->description_ar) }}</textarea>

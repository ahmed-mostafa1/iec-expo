...
@section('content')
    <h1 class="text-lg font-semibold mb-4">
        {{ __('Edit organizer') }} #{{ $organizer->id }}
    </h1>
    ...
    <form method="POST"
        ...
        <div class="grid grid-cols-1 gap-3">
            ...
            <div>
                ...
                <input type="text" name="name_ar" class="w-full rounded-lg border-gray-300 text-xs"
                       value="{{ old('name_ar', $organizer->name_ar) }}">
        ...
        <div>
            ...
            <input type="number" name="display_order" class="w-full rounded-lg border-gray-300 text-xs"
                   value="{{ old('display_order', $organizer->display_order) }}">
        ...
        <div class="flex items-center gap-2">
            <input type="checkbox" name="is_active" value="1"
                   ...
                   @checked(old('is_active', $organizer->is_active))>
        ...
        <div>
            ...
            <textarea name="description_en" rows="3"
                      class="w-full rounded-lg border-gray-300 text-xs">{{ old('description_en', $organizer->description_en) }}</textarea>
        ...
        <div>
            ...
            <textarea name="description_ar" rows="3"
                      class="w-full rounded-lg border-gray-300 text-xs">{{ old('description_ar', $organizer->description_ar) }}</textarea>
        ...
        <div>
            ...
            @if($organizer->logo_path)
                <div class="mb-2">
                    <img src="{{ asset('storage/'.$organizer->logo_path) }}" alt="" class="h-10 w-auto object-contain">
                </div>
            @endif

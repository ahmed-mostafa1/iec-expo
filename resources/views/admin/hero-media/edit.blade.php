    ...
    <form method="POST"
        ...
        <div>
            ...
            <textarea name="subtitle_en" rows="2"
                      class="w-full rounded-lg border-gray-300 text-xs">{{ old('subtitle_en', $item->subtitle_en) }}</textarea>
        ...
        <div>
            ...
            <textarea name="subtitle_ar" rows="2"
                      class="w-full rounded-lg border-gray-300 text-xs">{{ old('subtitle_ar', $item->subtitle_ar) }}</textarea>

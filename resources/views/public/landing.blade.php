...
fbq('init', '2930634037274791');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=2930634037274791&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
</head>
                    ...
                    <div class="registration-content">
                        <div class="role-cards" id="role-cards">
                            ...
                            <div class="form-card" id="exhibitor-form">
                                ...
                                $sponsorTierPlaceholder = $translate([
                                'en' => 'Select sponsor tier',
                                'ar' => 'اختر فئة الرعاية',
                                ]);
                                $sponsorTierOptions = [
                                ...
                                $exCrCopyLabel = $fieldCopy($exhibitorFieldsStepTwoByName, 'cr_copy_file', 'label', [
                                    ...
                                    <div>
                                        ...
                                        <div class="form-grid form-grid-2" style="margin-top:1rem;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="sponsor_tier" class="form-select" required>
                                                    <option value="" data-en="{{ e($sponsorTierPlaceholder['en']) }}"
                                                        data-ar="{{ e($sponsorTierPlaceholder['ar']) }}">
                                                        {{ $sponsorTierPlaceholder['text'] }}
                                                    </option>
                                                    @foreach ($sponsorTierOptions as $optionValue => $optionLabels)
                                                    @php
                                                    $optionLabelEn = data_get($optionLabels, 'en', '');
                                                    $optionLabelAr = data_get($optionLabels, 'ar', $optionLabelEn);
                                                    $optionLabel =
                                                    $registrationLocale === 'ar' ? $optionLabelAr : $optionLabelEn;
                                                    @endphp
                                                    <option value="{{ $optionValue }}" @selected($sponsorFormActive &&
                                                        old('sponsor_tier')===$optionValue)
                                                ...
                                                @if ($sponsorFormActive && $errors->has('sponsor_tier'))
                                                <p class="mt-1 text-xs text-red-600">
                                                    {{ $errors->first('sponsor_tier') }}
                                                </p>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-grid form-grid-2" style="margin-top: 1rem;">
                                            <div class="form-group">
                                                ...
                                                @if ($sponsorFormActive && $errors->has('cr_copy_file'))
                                                <p class="mt-1 text-xs text-red-600">{{ $errors->first('cr_copy_file') }}
                                                </p>
                                                @endif
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="form-card guest-form" id="icon-form">
                                ...
                                $iconCrCopyLabel = $fieldCopy($iconFieldsStepTwoByName, 'cr_copy_file', 'label', [
                                    ...
                                    <div>
                                        ...
                                        <div class="form-grid form-grid-2" style="margin-top: 1rem;">
                                            <div class="form-group">
                                                ...
                                                @if ($iconFormActive && $errors->has('cr_copy_file'))
                                                <p class="mt-1 text-xs text-red-600">{{ $errors->first('cr_copy_file') }}
                                                </p>
                                                @endif
                                            </div>
                            ...
                            <div class="form-card" id="icon-plus-form">
                                ...
                                $iconPlusCrCopyLabel = $fieldCopy($iconPlusFieldsStepTwoByName, 'cr_copy_file', 'label', [
                                'en' => trans('registration.icon_plus.cr_copy', [], 'en'),
                                'ar' => trans('registration.icon_plus.cr_copy', [], 'ar'),
                                ]);
                                $iconPlusCrCopyHint = $fieldCopy($iconPlusFieldsStepTwoByName, 'cr_copy_file', 'hint', [
                                'en' => trans('registration.icon_plus.file_hint', [], 'en'),
                                'ar' => trans('registration.icon_plus.file_hint', [], 'ar'),
                                ]);
                                ...
                                <form id="icon-plus-registration-form" method="POST"
                                    ...
                                    <div class="form-grid form-grid-2" style="margin-top: 1rem;">
                                        <div class="form-group">
                                            ...
                                            @if ($iconPlusFormActive && $errors->has('cr_copy_file'))
            ...
            <section class="sponsors" id="sponsors">
                ...
                <div class="container">
                    ...
                    <div class="sponsor-tiers">
                        <!-- STRATEGIC -->
                        @if(!empty($sponsorGroups['strategic']) &&
                        $sponsorGroups['strategic']['sponsors']->isNotEmpty())
                        ...
                        @endif
                        <!-- GOVERNMENT -->
                        @if(!empty($sponsorGroups['government']) &&
                        $sponsorGroups['government']['sponsors']->isNotEmpty())
                        <div class="sponsor-tier">
            ...
            <section class="participants" id="participants">
                ...
                <div class="container">
                    ...
                    <div class="participants-grid">
                        ...
                        @php
                        $participantLogo = $participant->logo_path
                        ? asset('storage/' . $participant->logo_path)
                        : asset('img/placeholder-img.png');
                        $participantName = $participant->getLocalizedName($locale);
                        @endphp
                        <a href="{{ route('public.participants.show', ['locale' => $locale, 'participant' => $participant]) }}"
                            class="participant-card" data-animate>
                            <div class="participant-logo">
                                <img src="{{ $participantLogo }}" alt="{{ $participantName }}">
                            </div>
                        </a>
                        @endforeach
                    </div>
                            ...
                            <div class="sponsor-featured-content">
                                <div class="sponsor-featured-media">
                                    ...
                                    <a href="{{ $organizer->url }}" class="sponsor-visit-btn" target="_blank"
                                        rel="noopener">
                                        <span data-en="{{ e($organizerVisitCopy['en'] ?? __('Visit Website')) }}"
                                            data-ar="{{ e($organizerVisitCopy['ar'] ?? __('زيارة الموقع')) }}">
                                            {{ $organizerVisitCopy[$currentLocale] ?? ($currentLocale === 'ar' ? __('زيارة الموقع') : __('Visit Website')) }}
                                        </span>
                                        <svg class="icon icon-sm" viewBox="0 0 24 24">
                                            <path d="M5 12h14M12 5l7 7-7 7" />
                                        </svg>

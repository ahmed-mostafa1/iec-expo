...
<head>
    <meta charset="utf-8">
    <title>Icon Registration #{{ $registration->id }}</title>
    <style>
...
<body>
    <div class="header">
        ...
        <div>Icon Registration #{{ $registration->id }}</div>
    ...
    <table>
        <tr>
            ...
            <td>{{ $registration->document_path ? 'Included in PDF' : 'Not provided' }}</td>
        </tr>
        <tr>
            <td class="label">CR copy</td>
            <td>{{ $registration->cr_copy_path ? 'Included in PDF' : 'Not provided' }}</td>
        </tr>
        <tr>
            <td class="label">National address proof</td>
            <td>{{ $registration->national_address_doc_path ? 'Included in PDF' : 'Not provided' }}</td>
        </tr>
        <tr>
            <td class="label">Company logo</td>
            <td>{{ $registration->company_logo_path ? 'Included in PDF' : 'Not provided' }}</td>
        </tr>
    </table>
</body>
</html>

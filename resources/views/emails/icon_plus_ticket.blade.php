...
<p>Thank you for registering for the ICON+ package at IEC 360°. Your registration is confirmed.</p>

<p><strong>Please keep this QR code — you will need to present it at the entrance to be admitted to the expo.</strong></p>

<p>
    <img src="{{ $message->embedData($registration->qrPng(), 'icon-plus-qr.png', 'image/png') }}"
         alt="ICON+ entry QR code" width="320" height="320">
</p>
...
<div dir="rtl" lang="ar">
    ...
    <p>شكرا لتسجيلك في باقة ICON+ في IEC 360°. تم تأكيد تسجيلك.</p>

...
<p>Thank you for registering for the ICON+ Quartet package at Tujjar Expo 3rd edition. Your registration is confirmed.</p>

<p><strong>Please keep this badge — you will need to present it at the entrance to be admitted to the expo.</strong></p>

@if($badgeCardPng)
    <p>
        <img src="{{ $message->embedData($badgeCardPng, 'icon-plus-quartet-badge.png', 'image/png') }}"
             alt="ICON+ Quartet badge" width="560">
    </p>
@endif
...
<div dir="rtl" lang="ar">
    ...
    <p>شكرا لتسجيلك في باقة ICON+ Quartet في معرض تجار النسخة الثالثة. تم تأكيد تسجيلك.</p>

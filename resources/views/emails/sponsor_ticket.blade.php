...
<p>Thank you for registering as a sponsor for IEC 360°. Your registration is confirmed.</p>

<p><strong>Please keep this QR code — you will need to present it at the entrance to be admitted to the expo.</strong></p>

<p>
    <img src="{{ $message->embedData($registration->qrPng(), 'sponsor-qr.png', 'image/png') }}"
         alt="Sponsor entry QR code" width="320" height="320">
</p>
...
<div dir="rtl" lang="ar">
    ...
    <p>شكرا لتسجيلك كراعي في IEC 360°. تم تأكيد تسجيلك.</p>

...
return [
    ...
    'pages' => [
        ...
        'analytics' => [
            'en' => [
                'title' => 'IEC 360 EXPO Analytics Dashboard',
                'description' => 'Track IEC 360 EXPO engagement, acquisition, content, and registration analytics across trade and investment audiences.',
            ],
            'ar' => [
                'title' => 'لوحة تحليلات معرض IEC 360',
                'description' => 'تابع تحليلات التفاعل والتسجيل لجمهور معرض IEC 360 في قطاعات التجارة والاستثمار والاستشارات المهنية.',
            ],
        ],
        'hall_design' => [
            'en' => [
                'title' => 'IEC 360 EXPO Hall Map | Book Exhibition Space',
        ...
        'sponsor' => [
            'en' => [
                'title' => ':name | IEC 360 EXPO Sponsor',
    ...
    'visible_focus' => [
        'en' => [
            'title' => 'Business Sectors at IEC 360',

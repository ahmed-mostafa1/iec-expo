...
return new class extends Migration
{
    ...
    {
        Schema::create('icon_plus_quartet_registrations', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('location_selection')->index();
    ...
    {
        Schema::dropIfExists('icon_plus_quartet_registrations');
    }
};
